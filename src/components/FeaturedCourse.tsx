    ...
    <section className="bg-gray-100 py-8 px-4 md:py-16 md:px-20">
      <div className="max-w-full">
        ...
        <div className="flex flex-col gap-4 mb-8 md:flex-row md:items-center md:justify-between md:mb-12">
          ...
          <button className="btn btn-ghost text-sm self-start md:self-auto">Browse courses →</button>
        </div>
        ...
        <div className="bg-white rounded-3xl p-4 shadow-sm border border-gray-200 featured-course-container relative md:p-5">
          <div className="flex flex-col gap-6 h-full md:flex-row md:gap-6">
            ...
            <div className="w-full bg-gray-100 rounded-lg flex items-center justify-center featured-course-image aspect-video min-w-0 md:w-auto md:aspect-[374/232] md:min-w-60 md:flex-shrink-0">
            ...
            <div className="flex-1 flex flex-col gap-4 featured-course-content md:gap-6">
              <div className="space-y-3 md:space-y-4">
                ...
                <div className="flex flex-col gap-3 md:flex-row md:gap-6">
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 text-brand-navy">
              ...
              {/* Action Buttons */}
              <div className="flex flex-col gap-3 relative mt-auto flex-wrap md:flex-row md:items-center md:justify-between">
